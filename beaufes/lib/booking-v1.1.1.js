    ...
    function render(data) {
      ...
      order.forEach(key=>{
        ...
        group.forEach(s=>{
          ...
          const time=node('span',s.starts_at+'〜'+s.ends_at,'booking-time-label');
        ...
        if(sharedOverview&&!customerStaffOnly){const details=node('details');details.append(node('summary','体験会の内容を見る'),node('p',sharedOverview));section.append(details);}
